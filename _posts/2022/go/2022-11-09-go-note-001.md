...
Go语言是google在2009年发布的第二款编程语言，它是基于编译，垃圾收集和并发的编程语言，专门针对多处理器系统应用程序的编程进行了优化，使用Go编译的程序可以媲美C/C++代码的速度，而且更加安全，支持并行进程。特别是在云项目中，大部分都使用了Golang来开发。
...
七牛云算是第一家选go语言做服务端的公司，早在2011年，它就选择Go作为存储服务端的主体语言
...
![](/assets/images/2022/go/install-1.png)

1、下载后直接安装

选择环境目录

![](/assets/images/2022/go/install-2.png)
...
![](/assets/images/2022/go/go-goroot.png)
...
![](/assets/images/2022/go/mac-user-home.png)

在`$HOME`目录下新建目录GoWorks，并新建新建src、bin、pkg三个子目录

![](/assets/images/2022/go/go-install-mac.png)
...
![](/assets/images/2022/go/go-install-mac-2.png)
...
![](/assets/images/2022/go/goland-install-1.png)

安装完后，启动goland

![](/assets/images/2022/go/goland-install-2.png)

发现跟idea 很相似

1、new project

![](/assets/images/2022/go/goland-install-3.png)

2、new file

![](/assets/images/2022/go/goland-install-4.png)
...
![](/assets/images/2022/go/hello-1.png)
...
![](/assets/images/2022/go/hello-2.png)

3、在golang新建hello.go

调整文字大小,file->setting

![](/assets/images/2022/go/goland-font-size.png)

执行hello.go报错

![](/assets/images/2022/go/hello-3.png)
...
![](/assets/images/2022/go/go-env-w-1.png)

再次执行

![](/assets/images/2022/go/hello-4.png)
