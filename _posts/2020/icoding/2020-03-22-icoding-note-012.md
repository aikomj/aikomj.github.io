...
tags: [icoding-edu]
keywords: springboot
excerpt: 精通Swagger，整合Yapi Api管理平台，@Async异步任务，@Scheduled定时任务，邮件任务，富文本编辑器EditorMd详解
lock: noneed
---
...
账号在安装yapi的时候有提示，密码默认是，密码在登录后在个人中心修改
...
![](assets\images\2021\springcloud\yapi-idea-project-token.png)
