...
![](/assets/images/2020/icoding/springboot-quickstart.gif)

![](/assets/images/2020/icoding/springboot-initializr.gif)
...
![](/assets/images/2020/icoding/springboot-run.png)
...
![](/assets/images/2020/icoding/springboot-dependencies.gif)

![](/assets/images/2020/icoding/springboot-plugins.gif)
...
![](/assets/images/2020/icoding/springboot-AutoConfigurationImportSelector.gif)

点进getCandidateConfigurations方法,发现它会断言存在<font color="red">META-INF/spring.factories</font>这个文件，不然就报错，显然这个文件很重要。

![](/assets/images/2020/icoding/springboot-loadFactoryNames.gif)

再来点进loadFactoryNames方法

![](/assets/images/2020/icoding/springboot-loadSpringFactories.gif)
...
![](/assets/images/2020/icoding/springbootApplication-springfactories.gif)

@SpringBootApplication分析思维导图：

![](/assets/images/2020/icoding/springboot-read-springfactories.gif)
...
![](/assets/images/2020/icoding/springboot-myself-banner.gif)

通过Debug模式，我们可以看到SpringbootApplication启动成功后，加载到Spring容器的所有bean

![](/assets/images/2020/icoding/springboot-beans-after-runsuccess.gif)
...
![](/assets/images/2020/icoding/springboot-yml-autowired.gif)

同理自动配置类也是通过@ConfigurationProperties前缀注入默认值的，如rabbitmq：

![](/assets/images/2020/icoding/springboot-yml-rabbitmq.gif)
...
![](/assets/images/2020/icoding/springboot-properties-file-encoding.gif)
...
![](/assets/images/2020/icoding/springboot-HttpEncodingAutoConfiguration.gif)

```java
// 表示这是一个配置类
@Configuration(proxyBeanMethods = false)
// 指定配置文件的封装属性类HttpProperties，如果配置文件有就使用配置文件的值，没有就使用HttpProperties的默认值
...
![](/assets/images/2020/icoding/springboot-myself-starter.gif)
...
![](/assets/images/2020/icoding/springboot-myself-starter-install.gif)

demo项目引入starter模块

![](/assets/images/2020/icoding/springboot-myself-starter-depend.gif)
...
![](/assets/images/2020/icoding/springboot-myself-starter-test.gif)

浏览器访问 /hello/starter

![](/assets/images/2020/icoding/springboot-myself-starter-test2.gif)