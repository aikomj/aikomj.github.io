...
![](D:\jacob\code\aikomj.github.io\assets\images\2021\juc\concurrent-hashmap.jpg)

`Segment`继承自 `ReentrantLock`，在此扮演锁的角色。可以理解为我们的每个`Segment`都是实现了`Lock`功能的`HashMap`，看上图`Segment`数组的长度是15，所以最高并发是15个线程。

**put**流程如下：

![](D:\jacob\code\aikomj.github.io\assets\images\2021\juc\concurrent-hashmap-put.jpg)
...
![](D:\jacob\code\aikomj.github.io\assets\images\2021\juc\concurrent-hashmap-put-jdk8.jpg)
