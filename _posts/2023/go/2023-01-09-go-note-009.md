...
tags: ['base']
keywords: go
excerpt: go语言没有try catch捕获错误，而是函数返回值返回错误，errors.new返回错误类型，自定义error错误类型，panic抛出异常，recover捕获异常恢复程序执行
lock: none
---
...
![](/assets/images/2022/go/os-open-1.png)

![](/assets/images/2022/go/os-open-2.png)
...
![](/assets/images/2022/go/errors-new.png)

![](/assets/images/2022/go/error-interface.png)
...
![](/assets/images/2022/go/fmt-errorf.png)
